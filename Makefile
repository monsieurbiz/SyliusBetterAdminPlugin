...
export COMPOSE_PROJECT_NAME=sylius_better_admin_plugin
PLUGIN_NAME=sylius-better-admin-plugin
COMPOSE=docker-compose
YARN=yarn
DOCTRINE_MIGRATIONS_NAMESPACE=MonsieurBiz\SyliusBetterAdminPlugin\Migrations
